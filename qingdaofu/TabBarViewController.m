...
//  qingdaofu
//
//  Created by zhixiang on 16/7/28.
...
@interface TabBarViewController ()<ZYTabBarDelegate>
...
- (void)setUpAllChildVc {
    ...
    [self setUpOneChildVcWithVc:MineVC Image:@"tab_user" selectedImage:@"tab_user_s" title:@"用户"];
}
