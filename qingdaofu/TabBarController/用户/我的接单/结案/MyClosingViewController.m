...
//        [_closingSwitchButton.sendButton setTitle:@" 评价发布方" forState:0];
//        [_closingSwitchButton.sendButton setImage:[UIImage imageNamed:@"evaluate"] forState:0];
    }
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (indexPath.section == 0) {
        ...
        if ([closeModel.loan_type integerValue] == 1) {
            ...
            rowString44 = @"应收帐款";
            rowString5 = [NSString stringWithFormat:@"%@万",closeModel.accountr];
            rowString55 = closeModel.seatmortgage;
...
//    else if (indexPath.section == 5) {//评价
//        PublishingResponse *resModel = self.orderCloseArray[0];
//        PublishingModel *closeModel = resModel.product;
...
//        EvaluateResponse *resp = self.evaluateResponseArray[0];
//        additionalEvaluateVC.evaString = resp.evalua;
//        additionalEvaluateVC.idString = closeModel.idString;
//        additionalEvaluateVC.categoryString = closeModel.category;
//        additionalEvaluateVC.codeString = closeModel.codeString;
//        
...
//            allEvaluationVC.categoryString = self.categaryString;
