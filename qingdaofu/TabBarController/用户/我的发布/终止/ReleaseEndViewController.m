    ...
    if (self.endArray.count > 0) {
        ...
        if (indexPath.section == 0) {
            ...
            if (self.scheduleReleaseEndArray.count > 0) {
                ...
                NSMutableAttributedString *dealDeailString = [cell.addressLabel setAttributeString:@"详        情：" withColor:kBlackColor andSecond:contentS withColor:kLightGrayColor withFont:12];
